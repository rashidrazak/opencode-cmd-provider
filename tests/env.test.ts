...
run([
  ...
  ["env overrides are honored", () => {
    assertEqual(getApiBase({ COMMANDCODE_API_BASE: "http://127.0.0.1:9999" }), "http://127.0.0.1:9999")
    assertEqual(getModelsUrl({ COMMANDCODE_MODELS_URL: "http://127.0.0.1:9999/models" }), "http://127.0.0.1:9999/models")
  ...
  ["data dir resolves XDG_DATA_HOME, then HOME/.local/share/opencode", () => {
    assertEqual(getDataDir({ XDG_DATA_HOME: "/x" }, () => "/home/u"), "/x")
    assertEqual(getDataDir({}, () => "/home/u"), "/home/u/.local/share/opencode")
  }],
])
