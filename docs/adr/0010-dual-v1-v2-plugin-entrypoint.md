...
| v1                                            | v2                                                | Notes                                                                                                                                                                            |
| --------------------------------------------- | ------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `config` hook → `provider.commandcode.models` | `ctx.catalog.transform`                           | `provider.update` / `model.update` are upserts; a missing record is seeded from `Provider.Info.empty(id)` / `Model.Info.default(providerID, id)` (ADR-0008 membership unchanged) |
