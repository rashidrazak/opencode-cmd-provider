...
export const MODEL_SNAPSHOT: readonly CatalogModel[] = [
  ...
  { id: "z-ai/glm-5.3-flashx", name: "GLM-5.3 FlashX", contextLength: 1000000, contextSource: "models.md", efforts: ["low","high","max"], cost: { input: 0.37, output: 1.25, cacheRead: 0.075, cacheWrite: 0 }, costSource: "models.md" },
  ...
  { id: "stepfun/Step-3.5-Flash", name: "Step 3.5 Flash", contextLength: 262000, contextSource: "models.md", efforts: null, cost: { input: 0.09, output: 0.3, cacheRead: 0.02, cacheWrite: 0 }, costSource: "models.md" },
  ...
  { id: "stealth/space-bunny-alpha", name: "Space Bunny Alpha", contextLength: 1000000, contextSource: "models.md", efforts: ["low","medium","high"], cost: { input: 0, output: 0, cacheRead: 0, cacheWrite: 0 }, costSource: "models.md" },
  { id: "stealth/pixel-canary", name: "Pixel Canary", contextLength: 262000, contextSource: "models.md", efforts: ["low","medium","xhigh"], cost: { input: 0, output: 0, cacheRead: 0, cacheWrite: 0 }, costSource: "models.md" },
  ...
  { id: "claude-opus-5-5", name: "Claude Opus 5.5", contextLength: 1000000, contextSource: "models.md", efforts: ["low","medium","high","xhigh","max"], cost: { input: 4, output: 20, cacheRead: 0.2, cacheWrite: 5 }, costSource: "models.md" },
  ...
  { id: "gpt-6-sol", name: "GPT-6 Sol", contextLength: 1050000, contextSource: "models.md", efforts: ["low","medium","high","xhigh","max"], cost: { input: 2, output: 10, cacheRead: 0.2, cacheWrite: 2.5 }, costSource: "models.md" },
  { id: "gpt-6-luna", name: "GPT-6 Luna", contextLength: 1050000, contextSource: "models.md", efforts: ["low","medium","high","xhigh","max"], cost: { input: 0.1, output: 0.5, cacheRead: 0.01, cacheWrite: 0.125 }, costSource: "models.md" },
