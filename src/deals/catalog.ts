...
export const MODEL_DEALS: Readonly<Record<string, ModelDeals>> = {
  "claude-fable-5": { tier: "premium", benchmark: {"intelligence":62.1,"tokPerSec":67.5}, free: false, allowance: {"goat":20,"pro":20} },
  "claude-haiku-4-5-20251001": { tier: "premium", benchmark: {"intelligence":24.1,"tokPerSec":101.1}, free: false, allowance: {"goat":20,"pro":20} },
  ...
  "claude-opus-5": { tier: "premium", benchmark: {"intelligence":63.1,"tokPerSec":54.4}, free: false, allowance: {"goat":20,"pro":20} },
  "claude-sonnet-4-6": { tier: "premium", benchmark: {"intelligence":48.4}, free: false, allowance: {"goat":20,"pro":20} },
  "claude-sonnet-5": { tier: "premium", benchmark: {"intelligence":55.3,"tokPerSec":81.9}, free: false, allowance: {"goat":20,"pro":20} },
  ...
  "google/gemini-3.5-flash-lite": { tier: "premium", benchmark: {"intelligence":37.4,"tokPerSec":361.2}, free: false, allowance: {"goat":20,"pro":20} },
  "google/gemini-3.6-flash": { tier: "premium", benchmark: {"intelligence":51.6,"tokPerSec":187.4}, free: false, allowance: {"goat":20,"pro":20} },
  ...
  "gpt-5.3-codex": { tier: "premium", benchmark: {"intelligence":45.5,"tokPerSec":132.3}, free: false, allowance: {"goat":20,"pro":20} },
  ...
  "gpt-5.6-terra": { tier: "premium", benchmark: {"intelligence":56.6,"tokPerSec":117.1}, overContext: {"input":4,"output":18,"cacheRead":0.4,"cacheWrite":5}, free: false, allowance: {"goat":20,"pro":20} },
  ...
  "Qwen/Qwen3.8-Flash": { tier: "opensource", free: false },
  ...
  "z-ai/glm-5.3-flash": { tier: "opensource", free: false },
  "zai-org/GLM-5": { tier: "opensource", benchmark: {"intelligence":40.6}, free: false, allowance: {"goat":20,"pro":30} },
  "zai-org/GLM-5.1": { tier: "opensource", benchmark: {"intelligence":41,"tokPerSec":28.2}, free: false, allowance: {"goat":20,"pro":30} },
